...
<body>
  ...
  if ($gia == 20) {
    $sql = "select * from laptop where giatien < 20000000 order by tenlaptop";
    $result = $con->query($sql);
  } else if ($gia == 25) {
    $sql = "select * from laptop where giatien >= 20000000 and giatien <=30000000 order by tenlaptop";
    $result = $con->query($sql);
  } else {
    $sql = "select * from laptop where giatien > 30000000 order by tenlaptop";
    $result = $con->query($sql);
  }
